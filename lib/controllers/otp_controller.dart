    ...
    if(start != 0) {
      ...
      await FirebaseAuth.instance.signInWithCredential(c)
        ...
        try {
          ...
          showSnackBar(message: 'otp number is not correct!');
        }
      });
      ...
      showSnackBar(message: 'otp number has been expired!!');
    }
  }
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
      ...
      verificationFailed: (FirebaseAuthException e) {
        if(e.toString().contains('too-many-requests')) {
          showSnackBar(message: 'We have blocked all requests from this device due to unusual activity');
        }
