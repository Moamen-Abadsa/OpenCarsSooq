...
class SignUpControllerImp extends SignUpController {
  ...
  checkVendor(bool newValue) {
    isVendor = newValue;
    newValue == true ? titleButton = 'Continue' : titleButton = 'Sign Up';
    update();
  }
  ...
  saveUser() async {
    if (signUpController.currentState!.validate()) {
      if (tecPassword.text == tecRePassword.text) {
        ...
        showSnackBar(message: 'Password and Re password not matched!');
      }
    }
  }
  ...
  void onInit() {
    ...
    if(Get.currentRoute == AppRoute.profileScreen) {
      tecName.text = appServices.getStringSharedPreferences(SharedPrefKeys.USER_NAME);
      tecEmail.text = appServices.getStringSharedPreferences(SharedPrefKeys.USER_EMAIL);
      tecAddress.text = appServices.getStringSharedPreferences(SharedPrefKeys.USER_ADDRESS);
      tecPhone.text = appServices.getStringSharedPreferences(SharedPrefKeys.USER_PHONE);
    }
    super.onInit();
  }
